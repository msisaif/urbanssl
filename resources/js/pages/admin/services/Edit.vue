...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Edit', href: `/admin/services/${props.service.id}/edit` },
];
...
const form = ref({
    ...
    is_published: props.service.is_published,
    sort_order: props.service.sort_order || 0,
});

const imagePreview = ref<string | null>(
    props.service.image ? `/storage/${props.service.image}` : null,
);
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            <div>
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Service</h2>
                <p class="text-sm text-gray-500 mt-1">Update "{{ service.title }}"</p>
            </div>
